...
public class EnemyCharacter extends Entity {
    ...
    private EnemyCharacter(String longname, String shortname, int x, int y, GameMap map, Ranges range, HashMap<Stats, Integer> unitStats) {
        super(longname, shortname, x, y, EntityType.ENEMY_UNIT, map, range);
    ...
    public static EnemyCharacter makeFirstBrigand(GameMap map){
        EnemyCharacter firstBrigand=new EnemyCharacter("FirstBrigand", "TEA", 7,3,map, Ranges.MELEE,EnemyCharacter.setStats(8,6,4,2,3,1,0,3,0,1));
    ...
    public static EnemyCharacter makeSecondBrigand(GameMap map){
        EnemyCharacter secondBrigand=new EnemyCharacter("SecondBrigand", "TEA", 6,2,map, Ranges.MELEE,EnemyCharacter.setStats(9,7,4,2,3,1,0,3,0,1));
    ...
    public static EnemyCharacter makeMage(GameMap map){
        EnemyCharacter mage=new EnemyCharacter("EnemyMage", "TEB", 9,3,map, Ranges.MAGIC,EnemyCharacter.setStats(10,7,5,3,1,1,0,1,0,1));
